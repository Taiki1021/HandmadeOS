...
MAINOBJS   = main.o wrapper.o video.o gdtidt.o memory.o kbd.o fifo.o
...
kernel.o: main.o wrapper.o video.o gdtidt.o trap.o trapasm.o vectors.o memory.o kbd.o fifo.o
	ld  -o $@ -T kernel.ld $^
