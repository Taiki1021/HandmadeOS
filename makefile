...
MAINOBJS   = main.o wrapper.o video.o gdtidt.o memory.o
...
kernel.o: main.o wrapper.o video.o gdtidt.o trap.o trapasm.o vectors.o memory.o
	ld  -o $@ -T kernel.ld $^
...
main.o:main.c wrapper.h video.h gdtidt.h memory.h
	gcc  -m32 $< -c
